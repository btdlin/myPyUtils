...
def test_with_filter_with_exclude_group(customer_name, site_id):
    ...
    payload = {
        "exclude": ["website|a428dc7c49e58aca62829d866fc97cb6", "website|b45d37e6aeff3aa0849dcfbd8754a5e5"],
        "caller": "bme",
        "medium": "email",
        "campaign": "4R%20-%20Semanal%20Autom%C3%A1tico",
        "batch": "2ae3703654a888349a924c13f8e00204_1486512000",
        "sections": [{
                "name": "article",
                "count": 11,
                "filters": [{
