...
def test_global_filter():
    candidates = CLIENT.get_candidates('70ec7833a06f2b6989747149874bb74d', filter=f.named_filter('GLOBAL'), limit=1000, sort_by=SortStrategy.POP_1D)
    #print(candidates)
...
def test_metafilter_resource_type_article():
    ...
    candidates = CLIENT.get_candidates('70ec7833a06f2b6989747149874bb74d', filter=f.and_filter(f.named_filter('GLOBAL'), filter), limit=1000, sort_by=SortStrategy.POP_1D)
