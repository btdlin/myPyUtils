...
def test_global_filter():
    candidates = CLIENT.get_candidates('92d7386bbdaae2999f701aa2a614eaeb', filter=f.named_filter('GLOBAL'), limit=1000, sort_by=SortStrategy.POP_1D)
    #print(candidates)
...
#    candidates = CLIENT.get_candidates('92d7386bbdaae2999f701aa2a614eaeb', filter=f.and_filter(f.named_filter('GLOBAL'), filter), limit=1000, sort_by=SortStrategy.POP_1D)
