...
def test_global_filter():
    candidates = CLIENT.get_candidates('8bf9fa832a2cf351cf1a19098038459d', filter=f.named_filter('GLOBAL'), limit=1000, sort_by=SortStrategy.POP_1D)
    print(candidates)
...
def test_metafilter_resource_type_article():
    ...
    candidates = CLIENT.get_candidates('8bf9fa832a2cf351cf1a19098038459d', filter=f.and_filter(f.named_filter('GLOBAL'), filter), limit=1000, sort_by=SortStrategy.POP_1D)
